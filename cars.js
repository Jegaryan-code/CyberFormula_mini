const CARSPECS = [
  ...
  { image: "2. AOI/Ex-Superion_ZA-10.png", acceleration: 5.1, handling: 0.8 , hasAero: true, hasBoost: true, turn: "none", driver: "Kaga"},
  ...
  { image: "2. AOI/Al-Zard NP-1_B.png", acceleration: 5.1, handling: 0.75 , hasAero: true, hasBoost: true, turn: "none", driver: "Kaga"},  
  { image: "2. AOI/Al-Zard NP-1_S.png", acceleration: 5.1, handling: 0.75 , hasAero: true, hasBoost: true, turn: "none", driver: "Nagumo"},
  { image: "2. AOI/Al-Zard NP-2.png", acceleration: 5.25, handling: 0.75 , hasAero: true, hasBoost: true, turn: "special", driver: "Shinjo"},

  { image: "2. AOI/EX-zard_ZA-11.png", acceleration: 5.3, handling: 0.8 , hasAero: true, hasBoost: true, turn: "special", driver: "Shiba"},  
  { image: "2. AOI/EX-zard_ZA-11_B.png", acceleration: 5.3, handling: 0.8 , hasAero: true, hasBoost: true, turn: "special", driver: "Shinjo"},
  { image: "2. AOI/EX-zard_ZA-11_C.png", acceleration: 5.3, handling: 0.8 , hasAero: true, hasBoost: true, turn: "special", driver: "Kaga"},
  
  { image: "2. AOI/Ex-Superion_ZA-8.png", acceleration: 5.0, handling: 0.88 , hasAero: true, hasBoost: true, turn: "none", driver: "Shoemach"},
  ...
  { image: "3. UNION SAVIOR/Issuxark_00-X3_II.png", acceleration: 5.0, handling: 0.8 , hasAero: false, hasBoost: true, turn: "special", driver: "Randoll"},
  { image: "3. UNION SAVIOR/Issuxark_00-X3_II_B.png", acceleration: 5.0, handling: 0.8 , hasAero: false, hasBoost: true, turn: "none", driver: "Shinjo"},
  { image: "3. UNION SAVIOR/Issuxark_00-X3_II_B.png", acceleration: 5.1, handling: 0.8 , hasAero: false, hasBoost: true, turn: "special", driver: "Sera"},
  ...
  { image: "5. MISSING LINK/STRATMISSIONNEL_MS-3B.png", acceleration: 4.9, handling: 0.6 , hasAero: false, hasBoost: false, turn: "special", driver: "Leon"},
  { image: "5. MISSING LINK/STRATMISSIONNEL_MS-3B.png", acceleration: 5.0, handling: 0.8 , hasAero: false, hasBoost: false, turn: "special", driver: "Henri"},
  { image: "5. MISSING LINK/Asurada_GST.png", acceleration: 4.8, handling: 0.8 , hasAero: false, hasBoost: false, turn: "none", driver: "Osamu"},  
  
  { image: "6. OTHERS SINGLE RACER/Albatrander_602.png", acceleration: 4.65, handling: 0.7 , hasAero: false, hasBoost: false, turn: "none", driver: "Otomo", teamLogo: "team/single/DDT.webp"},
  { image: "6. OTHERS SINGLE RACER/EL-CONDOL_B-15.png", acceleration: 4.7, handling: 0.75 , hasAero: false, hasBoost: false, turn: "none", driver: "Lopes", teamLogo: "team/single/AGS_Insignia.webp"},
  { image: "6. OTHERS SINGLE RACER/SILENT_SCREAMER-β.png", acceleration: 4.7, handling: 0.7 , hasAero: false, hasBoost: false, turn: "none", driver: "Heinel", teamLogo: "team/single/SGM.webp"},
