...
var TRACKS = [
  {
    ...
    pitEntry: { x: 2006, y: 3620 }, // 假設在直道左側
    // 2. Pit 站停車位座標 (車輛停下換胎的點)
    pitStop: { x: 2103, y: 2031 },  // 假設在這個位置停 3 秒
    ...
    pitWaypoints: [
      { x: 2010, y: 3620 }, // 從賽道駛入
      { x: 2100, y: 2800 },
      { x: 2103, y: 2031 }, // <-- Pit Stop 停車點
      { x: 2100, y: 1374 },
      { x: 2020, y: 1020 }  // Pit 出口 Waypoint
    ],
    // =====================================	
  ...
  },
  {
    ...
    // =====================================
    // 1. Pit 站入口座標 (玩家/AI 進入 Pit Lane 的點)
    pitEntry: { x: 356, y: 2676 }, // 假設在直道左側
    // 2. Pit 站停車位座標 (車輛停下換胎的點)
    pitStop: { x: 455, y: 1600 },  // 假設在這個位置停 3 秒
    // 3. Pit 站出口座標 (玩家/AI 重回賽道的點)
    ...
    pitWaypoints: [
      { x: 356, y: 2676 }, // 從賽道駛入
      { x: 450, y: 2200 },
      { x: 455, y: 1600 }, // <-- Pit Stop 停車點
      { x: 450, y: 1450 },
      { x: 374, y: 1347 }  // Pit 出口 Waypoint
    ],
    // =====================================	
  ...
  },
  {
    ...
    pitWaypoints: [
      { x: 586, y: 2893 }, // 從賽道駛入
      { x: 660, y: 2400 },
      { x: 670, y: 1900 }, // <-- Pit Stop 停車點
      { x: 660, y: 1600},
      { x: 582, y: 1480 }  // Pit 出口 Waypoint
    ],
    // =====================================	
  ...
  },
  {
    ...
    // =====================================
    // 1. Pit 站入口座標 (玩家/AI 進入 Pit Lane 的點)
    pitEntry: { x: 5180, y: 3799 }, // 假設在直道左側
    // 2. Pit 站停車位座標 (車輛停下換胎的點)
    pitStop: { x: 5574, y: 2945 },  // 假設在這個位置停 3 秒
    // 3. Pit 站出口座標 (玩家/AI 重回賽道的點)
    pitExit: { x: 5190, y: 1502 },
    ...
    pitWaypoints: [
      { x: 5180, y: 3799 }, // 從賽道駛入
      { x: 5500, y: 3200 },
      { x: 5574, y: 2945 }, // <-- Pit Stop 停車點
      { x: 5500, y: 2200 },
      { x: 5190, y: 1502 }  // Pit 出口 Waypoint
    ],
    // =====================================	
